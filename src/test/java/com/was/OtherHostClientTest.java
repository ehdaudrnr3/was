...
public class OtherHostClientTest {
...
//		HttpURLConnection connection = WebClient.getConnection("http://localhost:8081");
...
//		HttpURLConnection connection = WebClient.getConnection("http://localhost:8081/test");
...
//		HttpURLConnection connection = WebClient.getConnection("http://localhost:8081/test.exe");
//		WebClient.sendGet(connection);
//		
